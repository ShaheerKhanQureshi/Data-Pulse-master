...
class TestDataPulse(unittest.TestCase):
    ...
    def test_profile_data(self):
        ...
        self.assertEqual(profile['missing_values'], 0, "There should be no missing values in the dummy dataset")
    ...
    def test_compare_models(self):
        ...
        self.assertEqual(best_model['model'], 'Model2', "Best model should be Model2 with the highest accuracy")
